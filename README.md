...
#### Немного о сне
"Кратковременный сон" - это метод перехода в рассеянный режим благодаря короткой дреме. В комноте должно быть темно, вы сосредотачиваетесь на своем дыхании и ставите таймер на +-20 минут, чтобы не перекти в глубокий сон. За это время происходит что-то вроде когнитивной перезагрузки. 

Исследования показали что осн принципиально важен для работы памяти и для обучения. Во время сна происходит "уборка", усиление важнх и удаление тривиальных воспоминаний. Во время сна мы заного возвращаемся к некоторым самым сложным частям того, чему пытаемся обучиться и укрепляем нейронные связи. 
Сон - действенное средство, признанное усилить нашу способность решать сложные задачи и осознанно воспринимать материал (начальные данные уже должны быть заложены для продуктивной работы рассеянного режима). 
Мозг, которому не додает сна, не в состоянии формировать нейронные связи, обычные для нормального мыслительного процесса.
Бессонная ночь на кануне экзамена будет означать, что ваш мозг будет неспособен нормально функционировать. 
> Интересная идея: "если я работаю над задаче, то ложусь в пастель с блокнотом и ручкой и перед сном записываю все, что придет мне в голову в связи с обдумываемой моей проблемой, пока не усну".
...
Пока вы овладеваете предметом, можно найти свои способы быстро менять сфокусированное внимание на рассеянное и наоборот. Как например Магнус Карлс, который во время партии с Каспаровым встал из-за стола и смотрел на другие партии, благодаря чему избегал эффекта установки и отвлекал Каспарова. И тут важно помнить: глубокое сфокусированное внимание - важный фактор, поэтому не давайте себя отвлекать (если не пришло время сознательно переходить в рассеянный режим).
При работе над трудной задачей или в ходе усвоения материала почти всегда необходимы периоды, когда не происходит сознательной работы над задачей. Когда же вы снова переводите внимание на задачу, то вы собираете новые идеи и способы воедино.
Отдых между периодами сфокусированного мышления должен быть не меньше, чем требуется для полного отвлечения от решаемой задачи. При изучении новых понятий лучше вернуться к ним не позже чем через день. 
Перед принятием серьезных решений обычно полезно поспать. 

Если вы находитесь в тупике, то полезно узнать мнение сокурсников, но перед этим нужно самому попатеть над задачей. Усвоить материал - значит разобраться в знаниях, а для этого нужно эти знания иметь. 
> Для решения задачи нам нужно пристально сфокусировать внимание, однако сфокусирвание может закрыть путь к необходимому нам свежему подходу. При всей важности успеха не менее важен и неуспех. Как ни важно упорство, излишне упорные действия могут привести к лишнему раздражению и недовольству.

### Рабочая и долговременная память 
Рабочая память - это часть памяти, которая имеет дело с текущей, сознательно обрабатываемой информацией. Она может удерживать 4 порции информации. 
Мы прилагаем усилия храня информацию в рабочей памяти, иначе организм пустить затрачиваемую энергию в другое русло. Для удержании информации в рабочей памяти может помочь повторение и мысленное сосредотчение. 
В отличии от рабочей памяти, долговременную можно сравнить со складом. Склад велик и может вместить миллиарды обьектов, некоторые в таких глубинах, что их очень трудно достать. Для облегчения доступа к информации нужно еще несколько повторений, тогда ее будет проще достать в будущем. Помогает в этом **интервальное повторение**. 
...
### Порции информации (и илюзия компетентности)
